...
class AppColors {
  ...
  static const Color grey3D = Color(0xFF3D3D3D);
  ...
  static const Color green7D = Color(0xFF02BC7D);
  static const Color orange4A = Color(0xFFFF964A);

  //gradient colors for credit card authopass
  ...
  //gradient colors for preview screen
  static const Color blue5E = Color(0xFF01375E);
  static const Color blue6C = Color(0xFF013F6C);
  static const Color blueAA = Color(0xFF2386AA);
  static const Color blueDA = Color(0xFF3AB8DA);
